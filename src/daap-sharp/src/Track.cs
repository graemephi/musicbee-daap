            ...
            foreach (string field in fields) {
                ...
                switch (field) {
                    ...
                    case "daap.songdataurl":
                        val = String.Empty;
                        break;
                    case "daap.songextradata":
                        val = (short) 1;
                        wantsExtraData = true;
                        break;
                    case "daap.songartworkcount":
